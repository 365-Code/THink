        ...
        <div className='max-w-[95%] bg-[#181818] p-8 rounded-lg space-y-4'>
            ...
            <div className='space-y-4'>
                <div className='border focus-within:border-blue-500 flex items-center gap-2 px-2 rounded-lg transition-all'>
                    ...
                    <input type="text" autoComplete='off' placeholder='Enter Username' className='p-2 w-full bg-transparent' />
                </div>
                ...
                <button className='p-2 font-semibold bg-blue-500 hover:bg-blue-600 rounded-lg w-full'>Sign up</button>
            </div>
