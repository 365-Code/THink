    ...
    <>
    {
      ...
      </div>
      {
        ...
        <div className='flex-1 flex flex-col justify-center gap-2 text-center items-center'>
          ...
          src={'https://img.freepik.com/free-vector/no-data-concept-illustration_114360-626.jpg?w=740&t=st=1701196893~exp=1701197493~hmac=a125b6e7aa5744de73b6b9f04fab40710d06348c7c590d45e0a6a1782266b842'} alt='' />
